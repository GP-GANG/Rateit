    ...
    <body>
        ...
        <div id="container">
            <section id="default_page">
                ...
                <p id="note"> <marquee width="65%" direction="right" height="100px">
                    <b>NOTE:-</b> *Respective events will be displayed after clicking on dates*
                </marquee> </p>
                                    ...
                                    <div class="wole-box">
                                        <div class="comp-cont-box1">
                                            ...
                                            <div class="rcr-box">
                                                ...
                                                <br>
                                                <<<<<<< Upstream, based on origin/narmal2
